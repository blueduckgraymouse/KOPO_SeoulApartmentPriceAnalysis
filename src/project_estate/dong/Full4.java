					...
					/* 매매 조사 */
						...
						try {
							...
							try {	// 실거래가가 있는 경우
								...
								System.out.println("매매임시 : " + wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"tabpanel1\"]/div[4]/table/tbody/tr[1]/td/div/div/span"))).getText() + "/" + wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"tabpanel1\"]/div[4]/table/tbody/tr[1]/th"))).getText());
								...
								System.out.println(tempRecentRealtradePrice + "/" + tempRecentRealtradeDate);
						...
						try {		// 범위 내에 매물이 있는 경우
							...
							try {	// 실거래가가 있는 경우
								...
								clickRecentReal(wait);
								wait500ms();
								System.out.println("매매찐 : " + wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"tabpanel1\"]/div[4]/table/tbody/tr[1]/td/div/div/span"))).getText() + "/" + wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"tabpanel1\"]/div[4]/table/tbody/tr[1]/th"))).getText());
...
//		wait500ms();
		try {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[2]/div/section/div[2]/div[1]/div/div[2]/div[2]/div/div/div[1]/div/a[2]/div[1]/span"))).click();
			wait500ms();
		}
	}
