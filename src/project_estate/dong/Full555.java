						...
						while (true) {
							...
							try {
								...
								try {
									...
									// 최근 실거래가의 정보 가져오기
									int indexRealTrade = 1;			// 실거래가 한 줄에 해당하는 번호
									...
									System.out.println(indexRealTrade + "//" + guName + "," + dongName + "," + complexName.replaceAll(",", "") + "," + complexAddress + "," + tradeSize + "," + tradePrice + "," + recentTradeDate + "," + recentTradePrice + "," + maxTradeDate + ","  + maxTradePrice);
									System.out.println("---------------------------------------");
									bw.newLine();
									indexSize++;
								} catch (Exception ex) {
